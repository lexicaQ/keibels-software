...
const ModernAboutSection = () => {
  const skills = [
    { name: "Swift & SwiftUI", category: "Mobile & Desktop", level: 95 },
    { name: "iOS & macOS Development", category: "Mobile & Desktop", level: 90 },
    { name: "React & React Native", category: "Web & Mobile", level: 85 },
    { name: "TypeScript", category: "Web", level: 80 },
    { name: "UX/UI Design", category: "Design", level: 75 },
    { name: "Cloud Infrastructure", category: "Backend", level: 70 },
  ];
