  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-white overflow-x-hidden">
      <Helmet>
        ...
        <meta property="og:image" content={projectImage || "/lovable-uploads/bbb0c50f-bc0c-4cfe-aeff-8b5c288801fd.png"} />
        <meta property="og:type" content="article" />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:title" content={metaTitle} />
        <meta property="twitter:description" content={metaDescription} />
        <meta property="twitter:image" content={projectImage || "/lovable-uploads/bbb0c50f-bc0c-4cfe-aeff-8b5c288801fd.png"} />
      </Helmet>
      ...
      <div className="pt-24 pb-20 flex-grow">
        <div className="container mx-auto px-4">
          ...
          {/* Hero section with app screenshot - Fixed layout with proper image container */}
            ...
            >
              <div className="flex flex-col md:flex-row gap-10 z-10 relative">
                <div className="w-full md:w-3/5 z-10">
                  ...
                  {project.releaseStatus && (
                    ...
                    >
                      ...
                      <span className={`px-3 py-1 text-xs font-medium rounded-full shadow-inner ${
                        project.releaseStatus === 'Veröffentlicht' 
                ...
                <div className="w-full md:w-2/5 flex items-center justify-center">
                  {/* Fixed image container with proper styling to prevent the line issue */}
                  <motion.div 
                  ...
                  >
                    <div className="relative z-10 overflow-hidden rounded-xl shadow-2xl border border-white/20">
                      <ProjectImage 
                        imageUrl={projectImage} 
                        alt={project.title} 
                        className="max-h-[400px] w-auto object-contain" 
                      />
                      <div className="absolute inset-0 -bottom-1 bg-gradient-to-b from-transparent to-white/5 pointer-events-none"></div>
                    </div>
                  </motion.div>
                </div>
              </div>
