...
const ProjectDetail: React.FC<ProjectDetailProps> = ({
  ...
  const getFeatureIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case '🔗':
        return <LinkIcon className="text-white" size={20} />;
      case '📱':
        return <Smartphone className="text-white" size={20} />;
      case '💻':
        return <Laptop className="text-white" size={20} />;
      case '🔍':
  ...
  return <div className="min-h-screen flex flex-col bg-black text-white overflow-x-hidden">
      <Helmet>
      ...
      <div className="pt-24 pb-20 flex-grow">
        <div className="container mx-auto px-4">
          ...
          <section className="relative mb-16">
            ...
            <motion.div className="absolute top-0 left-0 w-108 h-108 bg-white/6 rounded-full blur-[200px] opacity-50 z-0" initial={{
            opacity: 0
          }} animate={{
            opacity: 0.5
          }} transition={{
            ...
            <motion.div className="absolute bottom-0 right-0 w-96 h-96 bg-white/4 rounded-full blur-[180px] opacity-40 z-0" initial={{
            opacity: 0
          }} animate={{
            opacity: 0.4
          }} transition={{
            ...
            duration: 0.6
              ...
              <div className="flex flex-col md:flex-row gap-10 z-10 relative">
                <div className="w-full md:w-3/5 z-10">
                  <div className="flex items-center mb-4">
                    ...
                    delay: 0.3
                      ...
                      {project.platform === 'iOS App' ? <span className="flex items-center">
                  ...
                  {project.releaseStatus && <motion.div initial={{
                  opacity: 0,
                  y: 20
                }} animate={{
                  opacity: 1,
                ...
                <div className="w-full md:w-2/5 flex items-start justify-center relative">
                  ...
                  <motion.div className="relative w-full" initial={{
                  opacity: 0,
                  scale: 0.9
                }} animate={{
                  opacity: 1,
                  ...
                  delay: 0.2
                    ...
                    <ProjectImage imageUrl={projectImage} alt={project.title} className="rounded-xl max-h-[400px] mx-auto shadow-2xl" />
                  </motion.div>
                </div>
              </div>
          ...
          <motion.section className="mb-16" variants={containerVariants} initial="hidden" animate="visible">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {project.highlights.map((highlight, index) => <motion.div key={index} variants={itemVariants} className="backdrop-blur-lg bg-white/5 border border-white/20 rounded-lg p-5 hover:bg-white/10 transition-all duration-300">
          ...
          {project.features && <motion.section className="mb-16" variants={containerVariants} initial="hidden" animate="visible">
              <motion.h2 variants={itemVariants} className="text-2xl font-bold mb-6 flex items-center">
              ...
              <Card className="bg-white/5 border-white/20 text-white">
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {project.features.map((feature, index) => <motion.div key={index} variants={itemVariants} className="flex gap-4 p-4 border border-white/20 rounded-lg bg-white/5">
          ...
          {project.useCases && <motion.section className="mb-16" variants={containerVariants} initial="hidden" animate="visible">
              <motion.h2 variants={itemVariants} className="text-2xl font-bold mb-6 flex items-center">
              ...
              <Card className="bg-white/5 border-white/20 text-white">
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {project.useCases.map((useCase, index) => <motion.div key={index} variants={itemVariants} className="p-4 border border-white/20 rounded-lg bg-white/5">
          ...
          {/* Updates section */}
          {project.updates && <motion.section className="mb-16" variants={containerVariants} initial="hidden" animate="visible">
              <motion.h2 variants={itemVariants} className="text-2xl font-bold mb-6 flex items-center">
              ...
              <Card className="bg-white/5 border-white/20 text-white">
                <CardContent className="p-6">
                  <div className="space-y-6">
                    {project.updates.map((update, index) => <motion.div key={index} variants={itemVariants} className="p-4 border border-white/20 rounded-lg bg-white/5">
                        <div className="flex justify-between items-center mb-3">
                          <span className="font-bold text-lg">Version {update.version}</span>
                          <span className="text-xs text-gray-400">{update.date}</span>
                        </div>
                        <div className="space-y-2">
                          {update.changes.map((change, idx) => <div key={idx} className="flex items-start">
          ...
          {/* Tech Stack section */}
          {project.techStack && <motion.section className="mb-16" variants={containerVariants} initial="hidden" animate="visible">
              <motion.h2 variants={itemVariants} className="text-2xl font-bold mb-6 flex items-center">
              ...
              <Card className="bg-white/5 border-white/20 text-white">
                <CardContent className="p-6">
                  <div className="flex flex-wrap gap-3 mb-6">
                    {project.techStack.map((tech, index) => <motion.span key={index} initial={{
                  opacity: 0,
                  y: 10
                }} animate={{
                  opacity: 1,
          ...
          <motion.section className="mb-16" variants={containerVariants} initial="hidden" animate="visible">
            ...
            <Card className="bg-white/5 border-white/20 text-white">
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <motion.div variants={itemVariants} className="p-4 border border-white/20 rounded-lg bg-white/5">
