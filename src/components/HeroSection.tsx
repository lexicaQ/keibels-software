...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center bg-black text-white overflow-hidden">
      ...
      <div ref={containerRef} className="relative w-full max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
        <div className="relative z-10">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in tracking-tight">
            MAXIM KEIBEL
          </h1>
          <p className="text-xl md:text-2xl mb-3 text-gray-300 animate-fade-in-delayed tracking-wide">
      ...
      {/* Scroll-Down-Pfeil */}
      <a href="#projects" className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-white/50 hover:text-white transition-colors">
