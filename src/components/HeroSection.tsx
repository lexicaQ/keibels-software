...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-black text-white overflow-hidden">
      ...
      <div ref={containerRef} className="relative w-full max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative">
          ...
          <div className="relative glass-card rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 backdrop-blur-sm bg-black/30 p-6 transform transition-transform duration-300 translate-y-0 hover:translate-y-0">
              <h3 className="text-xl font-semibold mb-1">Maxim Keibel</h3>
      ...
      <a 
        href="#projects" 
        className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-white/50 hover:text-white transition-colors"
      >
